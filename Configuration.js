...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("2", "Test scalar sensor", endpointType.genericSensor);
  endpoints.addEndpoint("3", "Test on/off sensor", endpointType.appliance);
}
...
function validateDeviceAddress(address, result)
{
  ...
  if (address.length = 0) {
    result.ok = false;
    result.errorMessage = {
      en: "The address must be more than 0 characters long", 
