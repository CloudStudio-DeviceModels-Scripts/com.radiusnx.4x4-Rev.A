...
# Parsing + Configuration Script – com.radiusnx.4x4 - Rev. A

This **Parsing + Configuration** script is designed for the **com.radiusnx.4x4** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – com.radiusnx.4x4 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **com.radiusnx.4x4** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
